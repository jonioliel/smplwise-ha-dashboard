...
assert.ok(css.includes('.homeClockMain .homeClockValue,.themeControlly .homeInfoCanvas[class*="infoPremium-"] .homeClockMain small{text-align:var(--premium-text-align,start)!important}'), "mobile premium clock text must retain the selected logical alignment");
